...
cap = cv2.VideoCapture("/home/quocnc1/Documents/enroll_flow/project/output.mp4")
...
# def is_frontal(pose):
#     return 1.0 <= abs(pose[0]) <= 6.0 and 0.0 <= abs(pose[1]) <= 9.0

# def is_left(pose):
#     return (1.0 <= abs(pose[0]) <= 6.0 or 21.0 <= abs(pose[0]) <= 24.0) and -29.0 <= pose[1] <= -20.0

# def is_right(pose):
#     return (1.0 <= abs(pose[0]) <= 6.0 or 21.0 <= abs(pose[0]) <= 24.0) and 25.0 <= pose[1] <= 35.0
...
# create_user("/home/quocnc1/Documents/enroll_flow/project/output.mp4", "quocnc2")